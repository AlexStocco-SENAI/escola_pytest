...
@pytest.mark.parametrize("entrada, situacao_esperada",
                         [
                             ...
                             ([7.0], 7.0),                                #Calculo basico com apenas 1 nota
                             ([5.0, 8.8, 6.7, 2.0, 5.3, 8.8, 9.9], 6.6),  #Calculo basico com 7 notas
                             ([5.8, 9.3], 7.5),                           #Testando o arredondamento decimal 0.55
                             ([0.8, 0.0, 0.0], 0.3),                      #Testando o arredondamento decimal maior que 0.56
                             ([5, 6, 10], 7.0)                            #Testando número inteiro
                         ]
                         )
